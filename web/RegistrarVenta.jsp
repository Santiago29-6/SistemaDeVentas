                    ...
                    <form action="Controlador?menu=NuevaVenta" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nombrescliente" value="${c.getNomCliente()}" class="form-control" disabled/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nomproducto" value="${producto.getNomProducto()}" class="form-control" placeholder="Datos producto" disabled/>
                                </div>
                            </div>
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="stock" value="${producto.getStock()}" class="form-control" placeholder="Stock" disabled/>
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-sm-7">
                <div class="card">
                            ...
                            <tbody>
                                <c:forEach var="list" items="${lista}">
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="Controlador?menu=NuevaVenta&accion=Editar&id=${list.getIdproducto()}}" class="btn btn-warning">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                                </svg>
                                            </a>
                                            <a href="Controlador?menu=NuevaVenta&accion=Delete&id=${list.getItem()}" class="btn btn-danger" style="margin-left: 10px">
                    ...
                    <div class="card-footer d-flex">
                        <div class="col-sm-6">
                            <a href="Controlador?menu=NuevaVenta&accion=GenerarVenta&idemp=${usuario.getId()}" onclick="print()" class="btn btn-success">
                            ...
                            <a href="Controlador?menu=NuevaVenta&accion=Cancelar" class="btn btn-danger">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-bag-x" viewBox="0 0 16 16">
